...
![Dashboard with the Subscription analytics dropdown open on the list of environments](find_environment.png){.screenshot-full}
...
![Total storage bar for one environment, split into Assets, Documents, Fonts, Preview data, Backup and Other](env_breakdown.png){.screenshot-full}
