...
![Empty Collections page with the Create your first collection prompt and Create collection button](empty-collection.png){.screenshot-full}

![The Create collection dialog with an empty, required Collection name field](create-collection.png){.screenshot-full}
...
![Add to collection panel over the template list, with POS material and Print ticked](add-to-collection.png){.screenshot-full}
