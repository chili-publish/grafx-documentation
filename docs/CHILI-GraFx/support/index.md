...
![The help menu at the lower right of the platform, with the Support link circled](support01.png){.screenshot-full}
...
![The CHILI MySupport home page, with the Support tile enlarged next to Mastering CHILI and Documentation](support02.png){.screenshot-full}
