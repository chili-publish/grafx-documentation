...
We are working hard on delivering an end-to-end process, from Smart Templates created by designers to output generated by end users. Check our [CHILI GraFx Guides](/CHILI-GraFx/concepts/template-management/) to learn more about this new way of working.

The first step in this process is organizing your templates in [template collections](/CHILI-GraFx/guides/manage-collections/). This is available now!
...
![screenshot-fullwidth](/CHILI-GraFx/concepts/template-management/collections.png)
