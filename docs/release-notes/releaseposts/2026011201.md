...
![GraFx Studio icon](/assets/icon-GraFx-Studio.svg){.rn_icon} <span class="version-label">v1.36</span>

## ✨ New & Improved

![Text frame Columns](/release-notes/releasenotesassets/text_columns.png){screenshot-full}
...
[See how to set up Text Columns](/GraFx-Studio/guides/text-frame/#text-columns)
