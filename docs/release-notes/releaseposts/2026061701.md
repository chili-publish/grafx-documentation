...
Adding a new paragraph by pressing Enter in description input fields — for example on templates or components — was silently ignored in some cases. This is now fixed.
