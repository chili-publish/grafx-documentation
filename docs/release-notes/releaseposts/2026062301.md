...
![Smart Crop Improvements](/release-notes/releasenotesassets/smartcrop2.png){.screenshot-full}

Smart Crop is the GraFx Studio fill mode that automatically zooms and positions an image inside a frame so the most important part stays in view, based on the image's Subject Area and POI (Point of Interest). This release is a major upgrade:
