...
![Comparison of the sRGB and CMYK color gamuts on a CIE 1931 xy chromaticity diagram](https://commons.wikimedia.org/wiki/Special:FilePath/CIE1931xy_gamut_comparison.svg){.screenshot}

<sub>Image: [CIE1931xy gamut comparison](https://commons.wikimedia.org/wiki/File:CIE1931xy_gamut_comparison.svg), Wikimedia Commons, CC BY-SA</sub>
