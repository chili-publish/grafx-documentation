...
- **Switch themes in GraFx Studio**: the Brand Kit panel's new theme selector updates every Brand Kit element used in the template, and sync is theme-aware — see [Switch themes](/GraFx-Studio/guides/brandkits/#switch-themes).
