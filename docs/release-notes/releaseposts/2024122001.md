...
Looking to scale up production using your Adobe® InDesign® documents? With the new Adobe® InDesign® plugin, now available as [experimental](/release-notes/experimental/), you can seamlessly convert them into GraFx Studio templates.
...
- **Export to GraFx Studio**:
  Use the "GraFx Studio Exporter" in Adobe® InDesign® to convert your designs to GraFx Studio packages.
