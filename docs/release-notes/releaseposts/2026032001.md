...
Date and time values in environment-level tables — such as Tags and Output tasks — now display in your browser's local timezone rather than UTC. Hover over any date to see the original server time in a tooltip.
