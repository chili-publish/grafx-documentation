...
![One beach-running photo reused in a wide banner, a square post and a narrow portrait, the runner framed in each](poi-ad.png){.screenshot-full}
...
- [3 Fill Mode Issues & How Smart Crop Prevents Them](https://www.youtube.com/watch?v=a-onWPzO_sQ&list=PLOzpLl2aXHcM)
- [Activate Smart Crop](https://www.youtube.com/watch?v=S6SJUxuJu-4&list=PLOzpLl2aXHcM)
- [Checking Subject Area and Points of Interest](https://www.youtube.com/watch?v=RniR5uGMtvQ&list=PLOzpLl2aXHcM)
...
![Beach photo with the detected Subject Area boxed around the runner and the Point of Interest on her eyes](poi.png){.screenshot}
...
![Image frame with Subject type Default: the whole scene of the woman carrying a grocery bag stays in frame](smart-crop-default.png){.screenshot-full}

![The Subject type dropdown open on People, and the same frame now filled by the woman's face and shoulders](smart-crop-people.png){.screenshot-full}

![The dropdown open on Product, and the same frame now filled by the bottle, lettuce and pepper in the bag](smart-crop-product.png){.screenshot-full}
