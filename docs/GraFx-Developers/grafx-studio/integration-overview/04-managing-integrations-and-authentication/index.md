...
See the [Environment API Quickstart](/GraFx-Developers/grafx-studio/environment-api/environment-api-quickstart/01-overview/) to get up to speed on using these tokens.
