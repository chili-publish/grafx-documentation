...
*fullres* (PDF / PNG / JPEG) | ✓ (e.g., Downloading the original image file in its highest quality. For asset types other then PNG / JPEG one sholud serve the asset wrapped to PNG / JPEG file ) | ✓ (e.g., Printing the original PDF or PNG / JPEG image file in its highest quality. For asset types other then PNG / JPEG / PDF one should serve the asset wrapped as a PDF file) | (e.g., Downloading the original image file in its highest quality. For asset types other then PNG / JPEG one sholud serve the asset wrapped to PNG / JPEG file )
*original* | ✓ | ✓ | ✓
