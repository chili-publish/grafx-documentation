...
![The unzipped template folder in Finder, with connector-infinity selected beside the connectors list](connectordoc02.png){.screenshot}
...
![The connectors folder in Finder, where connector-infinity sits alongside connector-canto and the others](connectordoc01.png){.screenshot-full}

Your folder should go in the structure:

docs > GraFx-Studio > connectors > **connector-infinity**

![Finder columns tracing docs, GraFx-Studio, connectors and connector-infinity down to the connector's files](connectordoc03.png){.screenshot-full}
...
![Contents of connector-infinity: index.md next to the image files infinity01.png to infinity05.png](connectordoc02.png){.screenshot-full}
...
![mkdocs.yml navigation with an Infinity Data entry added under "Connectors: Data", below Google Sheets](connectordoc04.png){.screenshot-full}
