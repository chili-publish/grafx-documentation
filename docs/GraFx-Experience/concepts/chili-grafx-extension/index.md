...
The CHILI GraFx extension is installed inside GraFx Experience and connects the portal to your CHILI GraFx environment. It makes Smart Templates from GraFx Studio available to portal users as campaigns.
...
When an end user opens a campaign and starts editing, the extension loads the Smart Template from GraFx Studio and presents it inside the portal's editing experience. When the user produces output, the request is sent to your CHILI GraFx environment to generate the file.
