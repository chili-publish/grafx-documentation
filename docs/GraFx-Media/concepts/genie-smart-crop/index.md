...
- [Smart Crop](/GraFx-Genie/concepts/smart-crop/): the full concept in the GraFx Genie section, covering how cropping works, the rules, subject types, and versions.
- [Set the Subject Area & POI](/GraFx-Media/guides/smart-crop-subject-area/): the step-by-step guide for reviewing and adjusting the metadata in GraFx Media.
