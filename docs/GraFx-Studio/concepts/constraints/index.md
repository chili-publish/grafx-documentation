...
**Image frames** support movement (horizontal and vertical), rotation, and resize — plus **crop**, letting the end user reposition the image inside a fixed frame.

**Shape frames** and **component frames** support movement (horizontal and vertical), rotation, and resize.
...
For the full options per frame type, see:

- [User Constraints for Text Frames](/GraFx-Studio/guides/text-frame/#user-constraints-for-text-frames)
- [User Constraints for Image Frames](/GraFx-Studio/guides/image-frame/#user-constraints-for-image-frames)
- [User Constraints for Shape Frames](/GraFx-Studio/guides/shape-frame/#user-constraints-for-shape-frames)
- [User constraints on a component frame](/GraFx-Studio/guides/use-components/#user-constraints-on-a-component-frame)
