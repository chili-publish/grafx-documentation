...
![screenshot-full](connector2.png){.screenshot-full}
...
![screenshot-full](damconnector01.png){.screenshot-full}
...
![screenshot-full](damconnector02.png){.screenshot-full}
...
![screenshot-full](damconnector05.png){.screenshot-full}

![screenshot-full](damconnector06.png){.screenshot-full}
