...
![screenshot](separate.png){.screenshot}
...
![screenshot-full](auth_1.png){.screenshot-full}
...
![screenshot](google22.png){.screenshot}

![screenshot-full](google23.png){.screenshot-full}
...
![screenshot-full](auth_2.png){.screenshot-full}
