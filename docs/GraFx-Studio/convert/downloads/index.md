# ![GraFx Studio app icon](/assets/icon-GraFx-Studio.svg){ .dl-hero-icon } GraFx Studio plugins

Pick the plugin for your Desktop App from the highlighted column. [Need GraFx Publisher? &rarr;](/GraFx-Publisher/convert/downloads/){ .dl-switch }

<div class="plugin-matrix studio" markdown>

|  | ![GraFx Studio icon marking the highlighted plugin column](/assets/icon-GraFx-Studio.svg){.matrix-icon}<br>GraFx Studio | ![GraFx Publisher](/assets/icon-GraFx-Publisher.svg){.matrix-icon}<br>GraFx Publisher |
|:---|:---:|:---:|
