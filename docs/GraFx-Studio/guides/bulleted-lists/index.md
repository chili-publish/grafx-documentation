...
Bulleted lists support up to five levels, each with its own icon and indent. Brand Kits include default bullet styles, and you can convert any text into a bulleted list or back to plain text.

## Define bullet styles in GraFx Brand Kits

1. Open your Brand Kit and select **Text** → **Paragraph Styles**.  
...
Changes in Brand Kits take effect in all text that use that paragraph style.
