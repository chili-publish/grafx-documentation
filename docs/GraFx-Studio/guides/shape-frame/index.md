...
![animation](corner-radius.gif){.screenshot-full}
...
![screenhot](corner-radius.png){.screenshot}
...
![screenshot](ellipse.png){.screenshot}
...
![screenshot](poly.png){.screenshot}
...
![screenshot-fullwidth](max-radius.gif){.screenshot-full}
