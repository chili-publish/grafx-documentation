...
![Create HTML Output a setting](html-02.png){.screenshot-full}
...
![Choose a layout in Run-mode](html-01.png){.screenshot}
...
![Choose a layout in Studio UI](html-04.png){.screenshot}
